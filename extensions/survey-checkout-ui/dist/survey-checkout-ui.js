...
${errorInfo.componentStack}`);
  ...
  var APP_URL = "https://shop-consolidation-strange-complaint.trycloudflare.com";
  function Attribution() {
      ...
      function FetchfromApisSurvey() {
        return __async(this, null, function* () {
          ...
          try {
            ...
            if (!response.ok) {
              throw new Error("Erreur lors de  la r\xE9cup\xE9ration des sondages");
            }
            const surveyData = yield response.json();
            setSurveyData(surveyData.surveys);
            return surveyData;
          } catch (error) {
            console.error("Erreur lors de la r\xE9cup\xE9ration des sondages :", error);
          }
        });
      }
      FetchfromApisSurvey();
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_jsx_runtime4.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Survey, { title: "How did you hear about us?", surveyData: SurveyData, onSubmit: handleSubmit, loading, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      ChoiceList,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Choice, { id: "tv", children: "TV" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Choice, { id: "podcast", children: "Podcast" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Choice, { id: "family", children: "From a friend or family member" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Choice, { id: "tiktok", children: "Tiktok" })
        ] })
      }
    ) }) });
  }
  function Survey({
    ...
    const [responses, setResponses] = (0, import_react15.useState)([]);
    const [customerInfo, setCustomerInfo] = (0, import_react15.useState)({
      customer: {
        id: "",
        lastName: "",
        email: "",
    ...
    const [reptext, settext] = (0, import_react15.useState)("");
    const [currentQuestionIndex, setCurrentQuestionIndex] = (0, import_react15.useState)(0);
    const [isResponseChanged, setResponseChanged] = (0, import_react15.useState)(false);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_jsx_runtime4.Fragment, { children: surveyData.length > 0 ? surveyData.map((surveyItem, index) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { border: "base", padding: "base", borderRadius: "base", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { variant: "headingMd", tone: "success", alignment: "center", as: "h1", children: surveyItem.title }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: surveyItem.description }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(View2, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { children: surveyItem.questions[currentQuestionIndex].content }),
        surveyItem.questions[currentQuestionIndex] ? (() => {
          const responseItem = surveyItem.responses.find(
            (response) => response.filteredResponses.some(
              (filteredResponse) => filteredResponse.question_id === surveyItem.questions[currentQuestionIndex].question_id
            )
          );
          return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_jsx_runtime4.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(View2, { children: [
            surveyItem.questions[currentQuestionIndex].question_type === "text" ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TextField, { value: reptext, onChange: (e) => handleResponseChange(surveyItem.questions[currentQuestionIndex].content, e) }) : null,
            surveyItem.questions[currentQuestionIndex].question_type === "Radio" ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { children: responseItem.filteredResponses.filter((filteredResponse) => filteredResponse.question_id === surveyItem.questions[currentQuestionIndex].question_id).map((filteredResponse, index2) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              ChoiceList,
              {
                name: "ship",
                value: "ship-1",
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                  Choice,
                  {
                    value: "",
                    id: "5",
                    children: filteredResponse.content
                  }
                )
              },
              filteredResponse.content
            )) }, index) : null,
            surveyItem.questions[currentQuestionIndex].question_type === "Checkbox" ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Checkbox, { children: responseItem.filteredResponses.filter((filteredResponse) => filteredResponse.question_id === surveyItem.questions[currentQuestionIndex].question_id).map((filteredResponse, index2) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              Checkbox,
              {
                value: "",
                id: "5",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { children: currentQuestionIndex === surveyItem.questions.length - 1 && // eslint-disable-next-line no-undef
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Button2, { kind: "secondary", onPress: handleValidate, children: "Valider" }) }),
      ...
      Survey,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          ChoiceList,
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Choice, { id: "5", children: "Amazing! Very happy with it." }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Choice, { id: "4", children: "It's okay, I expected more." }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Choice, { id: "3", children: "Eh. There are better options out there." }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Choice, { id: "2", children: "I regret the purchase." })
            ] })
          }
        )
      }
